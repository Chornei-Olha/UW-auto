    ...
    <div className="w-full pt-10">
      ...
      <div className="mt-6 text-gray-700 leading-relaxed font-medium font-montserrat text-sm sm:text-xl">
        {tab === 'Призначення' && (
          <>
            <p>
              SENSO ROSSA – це професійна автомалярна стрічка італійського виробництва, яка
              призначена для проведення лакофарбових робіт. Виготовляється з насиченого
              напівкрепованого паперу на який з одного боку нанесений клейовий шар на основі
              натурального каучуку. Червоний малярний скотч зручний у використанні, легко
              видаляється з поверхні без залишків клею, не пошкоджує структуру поверхні. Висока
              еластичність забезпечує відмінне прилягання на вигнуті та нерівні поверхні (арки, фари
              тощо). Має хороший рівень зчеплення стрічки до стрічки. Середній рівень адгезії
              забезпечує високу клейкість навіть до шорстких, фактурних і нерівних поверхонь.
              Відмінно фіксується на склі, металах, фарбах, лаках, поліпропілені, ПВХ, ABS,
              полікарбонаті, гумі, деревині. Утворює ідеально чіткі лінії та контури фарби з тонким
              профілем переходу. Автоскотч ROSSA має високий рівень стійкості до вологи, фарб на
              водній основі, розчинників. Витримує процес мокрого шліфування. Призначений для
              професійного фарбування. Використовується для захисту поверхонь при проведенні
              кузовних лакофарбових робіт. Застосовується у деревообробній і меблевій промисловості.
              Малярська стрічка має високу стійкість до дії уф-випромінювання, може
        ...
        {tab === 'Характеристики' && (
          <div className="overflow-x-auto mt-4">
            <ul className="list-disc list-inside space-y-1 mb-6">
              ...
              <li>Еластичність: 7%.</li>
              <li>Адгезія: 2,5Н/см.</li>
            </ul>{' '}
